<h1 align="center">Hi, I'm André Ahlert</h1>

<h3 align="center">Building developer tools, HTMX ecosystem tooling, and contributing to open source</h3>

<p align="center">
  <a href="https://twitter.com/andre_ahlert" target="blank"><img src="https://img.shields.io/twitter/follow/andre_ahlert?logo=twitter&style=for-the-badge" alt="andre_ahlert" /></a>
</p>

- 🏢 Founder @ [AEX Partners](https://github.com/AEX-Partners-Corp)

- 🔨 Building [**Kilnx**](https://github.com/kilnx-org/kilnx) - a backend language for the HTMX era

- 🧪 Building [**Provero**](https://github.com/provero-org/provero) - declarative data quality engine

- 🛠️ Building [**AToolZ**](https://github.com/atoolz) - developer tooling org (VS Code extensions, Railway templates, CLIs)

- 🌐 HTMX ecosystem: [htmx-devtools](https://github.com/atoolz/htmx-devtools), [htmx-vscode-toolkit](https://github.com/atoolz/htmx-vscode-toolkit), [Railway HTMX templates](https://github.com/atoolz?q=railway-htmx) for 8 stacks

- 🔌 Plugin Maintainer @ [Jenkins](https://github.com/jenkinsci/authorize-project-plugin) and [Backstage](https://github.com/backstage/community-plugins)

- 💬 Ask me about **HTMX, Python, Go, developer tooling**
...
<table>
  <tr>
    ...
    <td align="center" width="300">
      ...
      <sub>VS Code extensions, Railway templates, CLIs</sub>
    </td>
  </tr>
</table>
...
<p align="left">
  ...
  <a href="https://htmx.org" target="_blank"> <img src="https://raw.githubusercontent.com/bigskysoftware/htmx/master/www/static/img/htmx_logo.1.png" alt="htmx" width="40" height="40"/> </a>
...
I joined GitHub **20 months** ago and have since pushed **1,012** commits, opened **315** issues, submitted **218** pull requests, reviewed **31** PRs, and earned **212** stars across **33** personal projects and **4** organizations, with **33** PRs merged into external open source projects including Apache Airflow, Apache Burr, Flyte, Jenkins, Backstage, and ESLint.
